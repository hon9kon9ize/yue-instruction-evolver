...
if __name__ == "__main__":
    ...
    NUM_GENERATED_INSTRUCTIONS = 5000
    results = []
    save_every = 10
    filename = f'wizardlm_instructions_{datetime.datetime.now().strftime("%Y%m%d") + str(random.randint(0, 1000))}'
